...
$notes = <<<__EOD
usage: $self db investigatorId rawDataID MC_iterations cluster
...
<job_2dsa_mc run="1" mc_iterations="$mciter"/>
</p_2dsa>
<p_pcsa job_run="1">
...
db_obj_insert(
    $db_handle,
    "INSERT ${lims_db}.autoflowAnalysis (tripleName,filename,aprofileGUID,invID,statusJson,autoflowID,clusterDefault) values " .
    "( '$utriple', '$ufilename', '$aprofileGUID', $invID, '{\"to_process\":[\"2DSA_MC\"]}', $autoflowID, '$cluster' )" )
    ;
